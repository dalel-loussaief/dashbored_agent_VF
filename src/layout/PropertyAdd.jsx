...
const PropertyAdd = () => {
  ...
  useEffect(() => {
    ...
    const fetchLocalisations = async () => {
      try {
        ...
        toast.error('Error fetching localisations');
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        window.location.href = '/Property'; // Redirect after submission
      }, 3000);
    } catch (error) {
      ...
      <div style={styles.container}>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.formGroup}>
            ...
            <select
              id="Localisation"
              name="localisation" // changez 'location' en 'localisation'
              value={propertyData.localisation}
              onChange={handleChange}
              style={styles.input}
            >
